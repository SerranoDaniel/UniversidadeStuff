...
static const char *const yytname[] =
{
  ...
  "ADD", "MUL", "DIV", "NEG", "LPAR", "RPAR", "$accept", "input", "line",
  "exp", YY_NULLPTR
};
#endif
...
{
      -9,     0,    -9,    -9,     2,    -9,    18,    18,    -9,    26,
      18,    -9,    19,    -9,    18,    18,    18,    18,    30,    -9,
      -8,    -8,    -9,    -9
};
...
{
       2,    16,    17,     3,     4,     5,     0,     6,    10,    11,
      12,     0,     7,    18,     0,     0,     0,    20,    21,    22,
      23,     3,     4,     0,     0,     6,    14,    15,    16,    17,
       7,    13,    19,    14,    15,    16,    17,    14,    15,    16,
      17
};

static const yytype_int8 yycheck[] =
{
       0,     9,    10,     3,     4,     5,    -1,     7,     6,     6,
       7,    -1,    12,    10,    -1,    -1,    -1,    14,    15,    16,
      17,     3,     4,    -1,    -1,     7,     7,     8,     9,    10,
      12,     5,    13,     7,     8,     9,    10,     7,     8,     9,
      10
};
...
#line 44 "calc.y" /* yacc.c:1646  */
    {(yyval.val) = get_value((yyvsp[0].id)); 		}
...
#line 51 "calc.y" /* yacc.c:1646  */
    {set_value((yyvsp[-2].id),(yyvsp[0].val)); (yyval.val) = (yyvsp[0].val);	}
