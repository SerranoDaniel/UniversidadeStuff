...
estado_inicial([pbaixo(1),pbaixo(2),pbaixo(3),pbaixo(4),mvazia,adjacente(1,2),adjacente(2,3),adjacente(3,4),adjacente(2,1),adjacente(3,2),adjacente(4,3)]).
estado_final([pcima(1),pcima(2),pbaixo(3),pbaixo(4),mvazia,adjacente(1,2),adjacente(2,3),adjacente(3,4),adjacente(2,1),adjacente(3,2),adjacente(4,3)]).

accao(agarra(C1,C2),[mvazia, adjacente(C1,C2)],[mao(C1,C2)],[mvazia]).
