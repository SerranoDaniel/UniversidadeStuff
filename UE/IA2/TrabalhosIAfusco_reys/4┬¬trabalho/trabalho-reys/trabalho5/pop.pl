...
% frente(C1,C2) - está à frente dos copos C1 e C2
...
% desloca(C1,C2) - passa para a frente dos copos C1 e C2

estado_inicial([pbaixo(1),pbaixo(2),pbaixo(3),pbaixo(4),mvazia,adjacente(1,2),adjacente(2,3),adjacente(3,4),adjacente(2,1),adjacente(3,2),adjacente(4,3),frente(1,2)]).
estado_final([pcima(1),pcima(2),pcima(3),pbaixo(4),mvazia,adjacente(1,2),adjacente(2,3),adjacente(3,4),adjacente(2,1),adjacente(3,2),adjacente(4,3),frente(1,2)]).

accao(desloca(C1,C2),[mvazia, frente(C3,C4)],[frente(C1,C2)],[frente(C3,C4)]).

accao(agarra(C1,C2),[mvazia, frente(C1,C2)],[mao(C1,C2)],[mvazia]).

accao(viraCC(C1,C2),[mao(C1,C2),pbaixo(C1),pbaixo(C2)],[pcima(C1),pcima(C2),mvazia],[mao(C1,C2),pbaixo(C1),pbaixo(C2)]).

accao(viraBB(C1,C2),[mao(C1,C2),pcima(C1),pcima(C2)],[pbaixo(C1),pbaixo(C2),mvazia],[mao(C1,C2),pcima(C1),pcima(C2)]).

accao(viraCB(C1,C2),[mao(C1,C2),pbaixo(C1),pcima(C2)],[pcima(C1),pbaixo(C2),mvazia],[mao(C1,C2),pbaixo(C1),pcima(C2)]).

accao(viraBC(C1,C2),[mao(C1,C2),pcima(C1),pbaixo(C2)],[pbaixo(C1),pcima(C2),mvazia],[mao(C1,C2),pcima(C1),pbaixo(C2)]).
