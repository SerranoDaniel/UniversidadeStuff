...
%----------------------------Estados--------------------------------------
estado_inicial([na_mao([]),no_chao(a),cima(d,a),no_chao(b),cima(c,b),livre(d),livre(c)]).

estado_final([no_chao(d),cima(b,d),cima(c,d)],cima(a,b),cima(a,c)).
...
accao(retira_pequeno_do_chao(Pequeno),[na_mao([]),no_chao(Pequeno),livre(Pequeno)],[na_mao(Pequeno)],[na_mao([]),no_chao(Pequeno)]):-
	bloco(Pequeno,1).

accao(retira_grande_do_chao(Grande),[na_mao([]),no_chao(Grande)],[na_mao(Grande)],[na_mao([]),no_chao(Grande)]):-
	bloco(Grande,2).
