...
estado_inicial([pbaixo(1),pcima(2),pbaixo(3),pbaixo(4),mvazia,adjacente(1,2),adjacente(2,3),adjacente(3,4),frente(1,2)]).
estado_final([pcima(1),pcima(2),pcima(3),pbaixo(4),mvazia,adjacente(1,2),adjacente(2,3),adjacente(3,4),frente(1,2)]).

accao(desloca(C1,C2),[mvazia, frente(C3,C4),adjacente(C1,C2)],[frente(C1,C2)],[frente(C3,C4)]).

accao(agarra(C1,C2),[mvazia, frente(C1,C2),adjacente(C1,C2)],[mao(C1,C2)],[mvazia]).
