...
accao(abreGaveta1, 
	[mao(chave1), gavetaFechada1, gavetaFechada2], 
	[gavetaAberta1, mao(vazia), livre(arma)],
	[mao(chave1),gavetaFechada1]).

accao(abreGaveta2,
	[mao(chave2),gavetaFechada1,gavetaFechada2], 
	[gavetaAberta2, mao(vazia), livre(chave1)],
	[mao(chave2),gavetaFechada2]).

accao(
	fechaGaveta1,
	[mao(vazia),gavetaAberta1],
	[gavetaFechada1],
	[gavetaAberta1]).

accao(fechaGaveta2,
	[mao(vazia),gavetaAberta2],
	[gavetaFechada2],
	[gavetaAberta2]).
...
accao(mataPeru(bangbang), 
	[mao(arma),peruVivo(sim)],
	[peruVivo(nao)],
	[peruVIvo(sim)]).

estado_inicial([mao(vazia),gavetaFechada1, gavetaFechada2,livre(chave2),peruVivo(sim)]).
estado_final([mao(vazia),gavetaFechada1, gavetaFechada2,peruVivo(nao),livre(arma)]).
