...
escolheCi(p(Passos,Ordem,Links),Si,Ci,p([Si-op(Nome,Cond1,Add,Del)|Passos1], Ordem,Links)):-
...
escolheSk(p(Passos,Ordem,Links),S,C,p(Passos,[m(Sk,S)|Ordem],[link(Sk,S,C)|Links])):-
...
novo(O):- 
	retract(n(I)), J is I+1, asserta(n(J)),
