...
estado_inicial(([g,g,g,p,p,p,p,g,p,p,g,g,g,p,g,g,g,p,p,p], _, _, _)).

% o estado é um tuplo com 4 elementos a lista com as galinhas e patos, o número de animais mortos pela senhora, o número de animais mortos pelo senhor e o último que retirou galinhas(ultimo jogador)
